;(function (window, undefined) {
    'use strict';
    window.stuScheduleQuery_scheduleQueryController = function ($scope, $http, $state, $timeout, $uibModal, $cookies, $compile, $rootScope, $window, baseinfo_generalService, alertService, app) {
...
//		// 获取周次的信息并刷新数据，每次点击重新请求数据【参数：当前学年学期    & 所选周次】
	...
	stuScheduleQuery_scheduleQueryController.$inject = ['$scope', '$http', '$state', '$timeout', '$uibModal', '$cookies', '$compile', '$rootScope', '$window', 'baseinfo_generalService', 'alertService', 'app'];
})(window);